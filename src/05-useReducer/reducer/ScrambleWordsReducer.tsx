...
import { getInitialState, scrambleWordReducer } from './scrableWordReducer';
...
export const ScrambleWordsReducer = () => {
  ...
  const { 
    words ,currentWord ,errorCounter ,guess,
    isGameOver ,maxAllowErrors, maxSkips ,points ,
    scrambledWord ,skipCounter ,totalWords,
  } = state;
